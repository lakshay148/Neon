...
import com.truedev.neon.Utils.CameraPreview;
...
public class CameraPriorityFragment extends Fragment implements View.OnClickListener , View.OnTouchListener , Camera.PictureCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        buttonCapture = (ImageButton) fragmentView.findViewById(R.id.buttonCapture);
        buttonGallery = (ImageButton) fragmentView.findViewById(R.id.buttonGallery);
        buttonDone = (ImageButton) fragmentView.findViewById(R.id.buttonDone);
