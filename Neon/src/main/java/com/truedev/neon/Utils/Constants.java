...
public class Constants {
    ...
    public static final String ORIENTATION_REVIEW = "review_orientation";
    public static final String IMAGE_TAGS = "imageTags";
    public static final long STANDARD_ANIMATION_DURATION = 1000;
    public static final int REQUEST_PERM_CAMERA = 12;
    ...
    public static final int OPEN_IMAGE_VIEW_PAGER_SCREEN=102;
    ...
    public static File getMediaOutputFile(int type)
    {
        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES), "Gaadi Evaluator");
